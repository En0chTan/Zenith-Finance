            ...
            <div className="hidden lg:flex flex-col flex-1 bg-slate-950 text-white p-12 justify-between">
                <div>
                    ...
                    <div className="space-y-8 max-w-lg">
                        ...
                        <p className="text-slate-400 text-lg">
                            Join thousands of investors who trust us to manage, grow, and protect their wealth.
                        </p>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    <div className="flex items-center gap-4 border-l-2 border-blue-500 pl-4">
                        ...
                        <div>
                            <h3 className="font-medium text-slate-200">Secure & Confidential</h3>
                            <p className="text-sm text-slate-400">Your data is safe with our advanced security protocols.</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4 border-l-2 border-blue-500 pl-4">
                        <PieChart className="h-6 w-6 text-blue-400" />
                        <div>
                            <h3 className="font-medium text-slate-200">Comprehensive Portfolio</h3>
                            <p className="text-sm text-slate-400">Track all your assets and liabilities in one unified view.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center p-6 bg-slate-50 dark:bg-slate-900 border-l dark:border-slate-800">
                <Card className="w-full max-w-md shadow-lg border-slate-200 dark:border-slate-800">
                    <CardHeader className="space-y-2 pb-6">
                        ...
                        <CardTitle className="text-2xl font-bold tracking-tight text-center">Open an account</CardTitle>
                        <CardDescription className="text-center">
                            Enter your credentials to create your secure portal.
                        </CardDescription>
                    </CardHeader>
                    <form action={signup}>
                        ...
                        <CardFooter className="flex flex-col space-y-4 pt-4">
                            <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white" type="submit">Create Account</Button>
                            <div className="text-sm text-center text-slate-500 dark:text-slate-400">
                                Already have an account?{' '}
                                <Link href="/login" className="text-blue-600 hover:text-blue-700 font-medium hover:underline dark:text-blue-400 dark:hover:text-blue-300">
                                    Secure Log In
                                </Link>
                            </div>
                        </CardFooter>
